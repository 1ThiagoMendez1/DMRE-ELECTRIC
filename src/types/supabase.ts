...
export type TrabajoEstado = 'COTIZADO' | 'ACEPTADO' | 'EN_REVISION' | 'PAUSADO' | 'MODIFICACION' | 'CANCELADO'
export type CotizacionEstado = 'BORRADOR' | 'EN_REVISION' | 'ENVIADA' | 'APROBADA' | 'RECHAZADA' | 'MODIFICACION'
